...
{
	// Read input images
	// cv::Mat image1= cv::imread("..//lenovo//1.jpg",0);
	// cv::Mat image2= cv::imread("..//lenovo//2.jpg",0);

	cv::Mat image1= cv::imread("..//images//parliament2.bmp",0);
	cv::Mat image2= cv::imread("..//images//parliament1.bmp",0);
	...
	cv::warpPerspective(image2, // input image
		result,			// output image
		homography,		// homography
		cv::Size(2*image2.cols,image2.rows)  // size of output image
		);
