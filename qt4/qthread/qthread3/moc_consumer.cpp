...
**
** Created: Tue Dec 11 06:06:45 2012
...
static const char qt_meta_stringdata_CConsumer[] = {
    ...
    "back(int)\0done()\0consume(int)\0finish()\0"
};
...
int CConsumer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: back((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: done(); break;
        case 4: consume((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: finish(); break;
        default: ;
        }
        _id -= 6;
