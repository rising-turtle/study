...
public:
    ...
    explicit CPGicp(GpSet* , int n_threads = 2, double max_match_dist = 4);
    virtual ~CPGicp();
    ...
    virtual void AlignScan(GpSet*, dgc_transform_t base_t, dgc_transform_t t, double max_match_dist);
