...
namespace AISNavigation{
  ...
  template <typename T, typename I>
  PoseGraph<T,I>::Edge::Edge(Vertex* from, Vertex* to, const TransformationType& m, const InformationType& i) : Graph::Edge(from, to){
    setAttributes(m,i);
  }
  ...
  template <typename T, typename I>
  void PoseGraph<T,I>::Edge::setAttributes(const TransformationType& mean_, const InformationType& information_){
    _mean=mean_;
  ...
  template <typename T, typename I>
  typename PoseGraph<T,I>::Vertex* PoseGraph<T,I>::addVertex(int id, const TransformationType& pose, const InformationType& information){
  ...
  template <typename T, typename I>
  typename PoseGraph<T,I>::Edge*   PoseGraph<T,I>::addEdge(Vertex* from, Vertex* to, const TransformationType& mean, const InformationType& information) {
